      ...
      <Container size="prose" className="py-14 lg:py-20">
        ...
        <Section title="What we collect">
          <P>
            ...
            When you submit a brief through our contact form we collect your
            name, email address, and, where you choose to provide them, your
            company, the service you are interested in, your budget range, your
            timeline, the markets you are asking about, and the contents of your
            brief.
          </P>
          <P>
            <strong className="font-semibold text-foreground">
        ...
        <Section title="Why we use it">
          <P>
            ...
            We do not use it for marketing, we do not build profiles from it,
            and we do not sell it. The lawful basis is our legitimate interest
            in responding to people who contact us about our services, and,
            where you become a client, the performance of a contract.
          </P>
          <P>
        ...
        <Section title="Who else sees it">
          ...
          <P>
            ...
            your information with third parties, unless we are required to by
            law.
          </P>
        </Section>
        ...
        <Section title="How long we keep it">
          ...
          <P>
            ...
            will do so unless we are required to keep it.
          </P>
        </Section>
        ...
        <Section title="Your rights">
          <P>
            ...
            under the Nigeria Data Protection Act 2023 and, if you are in the
            EEA or the UK, under the GDPR. These include the right to ask for a
            copy of the data we hold about you, to have it corrected or deleted,
            to object to or restrict how we use it, and to ask us to transfer it
            elsewhere.
          </P>
          <P>
            To exercise any of these, email us at{" "}
            <A href={`mailto:${site.contact.email}`}>{site.contact.email}</A>.
            We will respond within one month. If you are unhappy with our
            response, you can complain to the Nigeria Data Protection
            Commission, or to your local supervisory authority if you are in the
            EEA or the UK.
          </P>
        </Section>
        ...
        <Section title="Changes to this notice">
          <P>
            ...
            analytics or an email newsletter, we will update this page and
        ...
        <p className="mt-8 text-sm text-muted-foreground">
          ...
          <Link
            href="/contact"
            className="rounded-sm link-rule text-accent-strong focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none"
          >
            Get in touch
          </Link>
          .
